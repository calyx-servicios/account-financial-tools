...
This module extends the functionality of Account Move to have a Yearly enumeration and print a xlsx report ordered by number.
...
Go to Accounting/Settings/Fiscal Years and create a Fiscal Year.

Usage
=====

1. Accounting/Reports/Account Move Fiscal Year
2. Select Fiscal Year or Period
3. Accounting/Configuration/Enum Account Moves (To enum all Account Move of selected Fiscal Year)
...
* `Federico Gregori <https://github.com/FedericoGregori>`_
