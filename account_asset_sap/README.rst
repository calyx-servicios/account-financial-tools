...
This module extends the functionality of account.assets and adds a new fields to import data from SAP system template.
...
This module is part of the `Account Financial Tools <https://github.com/calyx-servicios/account-financial-tools>`_ project on Github.