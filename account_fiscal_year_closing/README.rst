...
This module extends the functionality of account and allow make a closing for a fiscal year. 
...
#. Install Account Fiscal Year Backported by Calyx S.A.
#. Install the module.

Usage
=====

#. Go to Account -> Configuration -> Accounting Chart -> select a account for the recasting exercise.
#. Go to Account -> Configuration -> Journals -> select a journal for the recasting exercise, one for consolidation results and one for equity closing.
#. Configurations -> Fiscal Year Closing -> Select the period -> Select the options.
