====================================
Account Financial Report Usd Amount
====================================
...
This module extends the functionality of Account Financial Report and allows to you to generate the amounts in USD in the trial balance report.
 Also you can set an initial balance for accounts and see how this reflect it in the trial balance report.
...
To set a initial balance in usd:
1. Go to account -> Adviser -> Create a record with the date, the amount and the account (only one record per account)
...
This module is part of the `Calyx-Account-Financial-Tools <https://github.com/calyx-servicios/account-financial-tools>`_ project on GitHub.